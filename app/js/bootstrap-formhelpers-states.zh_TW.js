...
var BFHStatesList = {
  ...
  'HK':{
    '1' : {'code':'HCW','name':'香港島中西區'},
    '2' : {'code':'HEA','name':'香港島東區'},
    '3' : {'code':'HSO','name':'香港島南區'},
    '4' : {'code':'HWC','name':'灣仔區'},
    '5' : {'code':'KKC','name':'九龍城區'},
    '6' : {'code':'KKT','name':'觀塘區'},
    '7' : {'code':'KSS','name':'深水埗區'},
    '8' : {'code':'KWT','name':'黃大仙區'},
    '9' : {'code':'KYT','name':'油尖旺區'},
    '10' : {'code':'NIS','name':'離島區'},
    '11' : {'code':'NKT','name':'葵青區'},
    '12' : {'code':'NNO','name':'北區'},
    '13' : {'code':'NSK','name':'西貢區'},
    '14' : {'code':'NST','name':'沙田區'},
    '15' : {'code':'NTP','name':'大埔區'},
    '16' : {'code':'NTW','name':'荃灣區'},
    '17' : {'code':'NTM','name':'屯門區'},
    '18' : {'code':'NYL','name':'元朗區'}
  },
  'SG':{
    '1' : {'code':'CS','name':'Central Singapore'},
    '2' : {'code':'NE','name':'North East'},
    '3' : {'code':'NW','name':'North West'},
    '4' : {'code':'SE','name':'South East'},
    '5' : {'code':'SW','name':'South West'}
  },
  'MY':{
